...
사회문제 해결 해커톤 팀이 준비해 온 현장 문제와 샘플 자료를 바탕으로, 3시간 안에 보여줄 수 있는 AI 에이전트 MVP 기능 1개로 범위를 좁히고, 사례집/워크플로 라이브러리로 재사용 가능한 마크다운 산출물을 남기도록 돕는 Codex 스킬입니다.
...
```text
발표 때 반드시 보여줄 핵심 기능 1개만 남기면 무엇인가요?
```
